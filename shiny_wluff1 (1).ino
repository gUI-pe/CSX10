...
int melody[] = {
  //game win sound
  NOTE_F4,2, NOTE_F4,8, NOTE_GS4,8, NOTE_AS4,8,
  NOTE_AS4,4, NOTE_GS4,2, REST,2,
  NOTE_F4,2, NOTE_F4,8, NOTE_GS4,8, NOTE_AS4,8,
  NOTE_AS4,8, NOTE_GS4,4, NOTE_F4,4, NOTE_E4,8, NOTE_F4,4,
  REST,8,
  NOTE_AS4,8, NOTE_GS4,8, NOTE_F4,8, NOTE_E4,8, NOTE_F4,2,
  
};

int melody2[] = {
  //game over sound
  NOTE_DS7,12, NOTE_FS6,12, NOTE_DS7,12, NOTE_FS6,12,
  REST,4,
  NOTE_DS7,12, NOTE_FS6,12, NOTE_DS7,12, NOTE_FS6,12,
  REST,4,
  NOTE_DS7,12, NOTE_FS6,12, NOTE_DS7,12, NOTE_FS6,12,
